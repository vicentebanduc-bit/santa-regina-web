      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 32px", display: "flex", alignItems: "center", justifyContent: "space-between", height: transparent ? 76 : 64, transition: "height 0.5s ease" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10, cursor: "pointer" }} onClick={() => go("inicio")}>
          ...
          <div>
            ...
            <div style={{ fontSize: 9, color: `${AL}0.8)`, letterSpacing: 3, textTransform: "uppercase" }}>Family Office</div>
          </div>
        </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 48, marginBottom: 48 }}>
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 16 }}>
              <div style={{ width: 32, height: 32, border: `1px solid ${AL}0.3)`, borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center" }}>
      ...
      <section style={{
        ...
        <div style={{ maxWidth: 900, margin: "0 auto", padding: "120px 32px 80px", textAlign: "center", position: "relative", zIndex: 1 }}>
          <div style={{ opacity: loaded ? 1 : 0, transform: loaded ? "translateY(0)" : "translateY(20px)", transition: "all 1s cubic-bezier(0.16,1,0.3,1) 0.2s" }}>
            <div style={{ width: 64, height: 64, border: `1.5px solid ${AL}0.4)`, borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 32px" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: 48 }}>
              <div>
                <p style={{ fontSize: 17, color: "#333", lineHeight: 1.9, fontFamily: "'DM Sans', sans-serif", fontWeight: 300, margin: "0 0 24px" }}>
                  Santa Regina es el family office del grupo, creado para administrar, proteger y hacer crecer el patrimonio con una mirada de largo plazo y estándares institucionales.
                </p>
                <p style={{ fontSize: 17, color: "#333", lineHeight: 1.9, fontFamily: "'DM Sans', sans-serif", fontWeight: 300, margin: "0 0 24px" }}>
            ...
            <FadeIn>
              <div>
                ...
                <div style={{ marginTop: 24, padding: 24, background: "#fff", border: "1px solid rgba(0,0,0,0.04)" }}>
                  ...
                  <div style={{ fontSize: 13, color: "#999", fontFamily: "'DM Sans', sans-serif", fontWeight: 300, lineHeight: 1.7 }}>Santa Regina Family Office opera bajo estrictos estándares de confidencialidad y reserva.</div>
                </div>
              </div>
            </FadeIn>
            <FadeIn delay={0.15}>
